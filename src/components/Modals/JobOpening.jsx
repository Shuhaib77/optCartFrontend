...
export default function UseModal() {
  ...
  return (
    <div>
      <TriggerButton onClick={handleOpen}>Create Job Openings</TriggerButton>
      <Modal
        ...
        <Fade in={open}>
          <ModalContent sx={style}>
            ...
            <Box
              ...
              autoComplete="off"
            >
              <TextField id="job-title" label="Job Title" variant="outlined" />
              ...
              <TextField id="salary" label="Salary" variant="outlined" type="number" />

              <TextField id="experience" label="Experience (Years)" variant="outlined" type="number" />
...
const ModalContent = styled('div')(
  ({ theme }) => css`
    ...
    gap: 8px;
    overflow: auto;
    max-height: 80vh; /* Adjust as per requirement */
...
const TriggerButton = styled(Button)`
  ...
  &:hover {
    background-color:hsl(213, 73.10%, 43.70%);
  }
`;
